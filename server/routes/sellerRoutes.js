...
const {sellerRegister, sellerLogin, sellerProfile,updateSellerProfile, sellerLogout,createProduct,getAllProducts,getproductById,updateProduct} = require('../controllers/sellerController');
